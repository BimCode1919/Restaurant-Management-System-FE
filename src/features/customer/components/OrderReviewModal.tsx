...
// Định nghĩa Interface chính xác để khớp với CustomerMenu
interface OrderReviewModalProps {
  isOpen: boolean;
  onClose: () => void;
  cart: OrderItem[];         // Phải là cart, không phải items
  updateQty: (id: number, delta: number) => void; // Phải là updateQty
  total: number;
