...
interface MenuListViewProps {
  ...
  onView: (item: MenuItem) => void; // Thêm dòng này vào interface
}
          ...
          <div className="flex-1 flex flex-col justify-between py-1">
            <div onClick={() => onView(item)} className="cursor-pointer">
              <div className="flex justify-between items-start">
                ...
                <span className="text-burgundy font-black text-sm">{new Intl.NumberFormat('vi-VN').format(item.price)}đ</span>
              </div>
